...
public class ResultsAdapter extends RecyclerView.Adapter<ResultsAdapter.MyViewHolder> {
    ...
    public ResultsAdapter(Context mContext, ArrayList<Results> resultsList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ResultsAdapter.MyViewHolder holder, final int position) {
