...
public class NewsResultsAdapter extends RecyclerView.Adapter<NewsResultsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<NewsResults> ResultsList;
    ...
    public NewsResultsAdapter(Context mContext, ArrayList<NewsResults> resultsList) {
        inflater = LayoutInflater.from(mContext);
        this.mContext = mContext;
        this.ResultsList = resultsList;
    }
    @Override @NonNull
    public NewsResultsAdapter.MyViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final NewsResultsAdapter.MyViewHolder holder, final int position) {
