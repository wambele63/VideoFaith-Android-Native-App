 ...
 * {@link AboutPage.OnFragmentInteractionListener} interface
...
public class AboutPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = inflate.findViewById(R.id.aboutpage);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.getSettings().getAllowFileAccess();
        webView.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);
        webView.loadUrl("https://firebasestorage.googleapis.com/v0/b/christiantube-7c50c.appspot.com/o/about.html?alt=media&token=2608b671-3546-439b-af2f-f91b740bec38");
        return inflate;
    }
