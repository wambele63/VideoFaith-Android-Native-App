...
public class VideoResultsAdapter extends RecyclerView.Adapter<VideoResultsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<VideoResults> ResultsList;
    ...
    public VideoResultsAdapter(Context mContext, ArrayList<VideoResults> resultsList) {
        inflater = LayoutInflater.from(mContext);
        this.mContext = mContext;
        this.ResultsList = resultsList;
    }
    @Override @NonNull
    public VideoResultsAdapter.MyViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final VideoResultsAdapter.MyViewHolder holder, final int position) {
        ...
        Glide.with(mContext).load( ResultsList.get(position).getContentPicture()).into(holder.contentpicture);
    }
